...
function refresh(){
    document.getElementById("ipt_alas").value="";
    document.getElementById("ipt_tinggi").value="";
    document.getElementById("opt_luas").value="";
    document.getElementById("opt_keliling").value="";
}
